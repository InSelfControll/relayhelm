# nix/overlays.nix — Expose pkgs.relayhelm for external NixOS configs
#
...
# `pkgs.relayhelm`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    relayhelm = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
