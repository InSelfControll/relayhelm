# nix/relayhelm.nix — Overridable Relayhelm package
#
...
stdenv.mkDerivation (finalAttrs: {
  ...
  installPhase = ''
    ...
    mkdir -p $out/share/relayhelm $out/bin
    ln -s ${bundledSkills} $out/share/relayhelm/skills
    ln -s ${bundledOptionalSkills} $out/share/relayhelm/optional-skills
    ln -s ${bundledPlugins} $out/share/relayhelm/plugins
    ln -s ${bundledLocales} $out/share/relayhelm/locales
    ln -s ${bundledOptionalMcps} $out/share/relayhelm/optional-mcps
    ln -s ${hermesWeb} $out/share/relayhelm/web_dist
    ...
    ${lib.concatMapStringsSep "\n"
      (name: ''
        makeWrapper ${hermesVenv}/bin/${name} $out/bin/${name} \
          ...
          --set HERMES_BUNDLED_SKILLS $out/share/relayhelm/skills \
          --set HERMES_OPTIONAL_SKILLS $out/share/relayhelm/optional-skills \
          --set HERMES_BUNDLED_PLUGINS $out/share/relayhelm/plugins \
          --set HERMES_BUNDLED_LOCALES $out/share/relayhelm/locales \
          --set HERMES_OPTIONAL_MCPS $out/share/relayhelm/optional-mcps \
          --set HERMES_WEB_DIST $out/share/relayhelm/web_dist \
          --set HERMES_TUI_DIR $out/ui-tui \
          --set-default HERMES_BIN $out/bin/relayhelm \
