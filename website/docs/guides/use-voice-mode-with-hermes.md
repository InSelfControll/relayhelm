---
sidebar_position: 8
title: "Use Voice Mode with Relayhelm"
description: "A practical guide to setting up and using Relayhelm voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Relayhelm
...
- you want Relayhelm sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Relayhelm.
...
## Step 1: make sure normal Relayhelm works first
...
Relayhelm supports both local and cloud speech stacks.
...
4. Relayhelm transcribes and responds
...
- asking Relayhelm to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Relayhelm loop.

## Tuning CLI behavior

### Silence threshold

If Relayhelm starts/stops too aggressively, tune:
...
Relayhelm stays a normal chat bot, but can speak replies.
...
- you want Relayhelm to function like a portable research or ops assistant
...
Relayhelm joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Relayhelm detects speech boundaries
- transcripts are posted in the associated text channel
- Relayhelm responds in text and audio
...
1. get text Relayhelm working
2. run `relayhelm setup tts` to enable voice support
