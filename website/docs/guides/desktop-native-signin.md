...
description: "How the Relayhelm Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Relayhelm Desktop app connects to a **gated gateway** (a hosted or
...
For Relayhelm specifically, native sign-in means:
...
- [Run Relayhelm with Nous Portal](./run-hermes-with-nous-portal.md)
