...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Relayhelm — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Relayhelm tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Relayhelm core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a Relayhelm Plugin](/developer-guide/plugins)
...
- [ ] Tested with `relayhelm chat -q "Use the weather tool for London"`
