...
Relayhelm supports three API execution modes, resolved from provider selection, explicit args, and base URL heuristics:
...
- The session can be resumed later via `/resume` or `relayhelm chat --resume`
