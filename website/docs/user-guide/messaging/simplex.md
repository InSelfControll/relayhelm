...
> Run `relayhelm gateway setup` and pick **SimpleX** for a guided walk-through.
...
- The connection between Relayhelm and the daemon is local WebSocket (`ws://127.0.0.1:5225`) — no data leaves your machine
