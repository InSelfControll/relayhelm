...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/health/neuroskill-bci` |
...
Connect Relayhelm to a running [NeuroSkill](https://neuroskill.com/) instance to read
