...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research\darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Relayhelm |
| License | MIT |
...
import upstream classes into Relayhelm itself.
...
Open `~/.relayhelm/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Relayhelm core.
   Custom driver scripts under `~/.relayhelm/skills/...` are user-side and fine.
