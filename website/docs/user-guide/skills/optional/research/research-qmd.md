...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`relayhelm`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-relayhelm), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Relayhelm via the native MCP client. This is the preferred
...
Then configure Relayhelm to connect via HTTP:
