...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/research/gitnexus-explorer` |
...
| Related skills | [`relayhelm`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-relayhelm), [`codebase-inspection`](/docs/user-guide/skills/bundled/software-development/software-development-codebase-inspection) |
