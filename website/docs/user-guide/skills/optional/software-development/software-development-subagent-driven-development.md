...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development\subagent-driven-development` |
| Version | `1.1.0` |
| Author | Relayhelm (adapted from obra/superpowers) |
| License | MIT |
