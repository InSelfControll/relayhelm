...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Relayhelm"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${HERMES_HOME:-~/.relayhelm}/.env`:
