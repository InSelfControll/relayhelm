...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain\hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Relayhelm |
| License | MIT |
...
The script reads `${HERMES_HOME:-~/.relayhelm}/.env` for two optional defaults:
...
Helper script: `~/.relayhelm/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.relayhelm/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${HERMES_HOME:-~/.relayhelm}/.env`.
...
```bash
python ~/.relayhelm/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.relayhelm/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
