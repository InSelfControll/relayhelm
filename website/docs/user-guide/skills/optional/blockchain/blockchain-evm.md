...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain\evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Relayhelm |
| License | MIT |
...
Helper script path: `~/.relayhelm/skills/blockchain/evm/scripts/evm_client.py`
...
python ~/.relayhelm/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.relayhelm/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
