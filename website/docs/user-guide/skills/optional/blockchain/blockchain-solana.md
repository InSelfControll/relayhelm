...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain\solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by Relayhelm |
| License | MIT |
...
Helper script path: ~/.relayhelm/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.relayhelm/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.relayhelm/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.relayhelm/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.relayhelm/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.relayhelm/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.relayhelm/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
