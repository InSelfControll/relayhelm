...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Relayhelm |
| License | MIT |
...
```
python ~/.relayhelm/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
