...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/web-development/page-agent` |
...
- User wants **Relayhelm itself to drive a browser** → use Relayhelm' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
