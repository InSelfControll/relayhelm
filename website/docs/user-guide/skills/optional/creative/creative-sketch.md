...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/creative/sketch` |
| Path | `optional-skills/creative\sketch` |
| Version | `1.0.1` |
| Author | Relayhelm (adapted from gsd-build/get-shit-done) |
| License | MIT |
...
**Verify variants visually — use Relayhelm' browser tools.** Don't just write HTML and hope it renders; load each variant and look at it:
