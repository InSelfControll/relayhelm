...
| | |
|---|---|
| Source | Optional — install with `relayhelm skills install official/creative/impeccable` |
...
> ships and verifies a Hermes-native skill bundle under `.relayhelm/skills/`.
> `relayhelm skills install impeccable` pulls the current bundle live from that
