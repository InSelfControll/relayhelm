...
| Version | `1.0.0` |
| Author | Relayhelm + Teknium (design systems sourced from VoltAgent/awesome-design-md) |
| License | MIT |
...
Each template includes a **Relayhelm Implementation Notes** block at the top with:
