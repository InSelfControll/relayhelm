...
Set your Tenor API key in your environment (add to `${HERMES_HOME:-~/.relayhelm}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/InSelfControll/relayhelm/blob/main/skills/media\gif-search/url)`
