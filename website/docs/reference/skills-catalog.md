...
| [`relayhelm`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-relayhelm) | Use, configure, theme, extend, and orchestrate Relayhelm. | `autonomous-ai-agents\relayhelm` |
...
| [`inspecting-hermes-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-hermes-desktop-dom) | Read the live Relayhelm desktop DOM/CSS over CDP. | `software-development\inspecting-hermes-desktop-dom` |
