#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Relayhelm docs site.
...
LLM reads to learn what Relayhelm does.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Relayhelm as a Python Library", None),
        ("guides/use-mcp-with-hermes", "Use MCP with Relayhelm", None),
        ("guides/use-voice-mode-with-hermes", "Use Voice Mode with Relayhelm", None),
        ("guides/use-soul-with-hermes", "Use SOUL.md with Relayhelm", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Relayhelm"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "relayhelm/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/InSelfControll/relayhelm")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Relayhelm — Full Documentation\n",
        (
            "This file is the entire Relayhelm documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Relayhelm, Features, Messaging, Integrations, Guides, "
