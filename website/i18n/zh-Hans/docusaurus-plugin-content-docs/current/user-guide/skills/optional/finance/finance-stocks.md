...
| | |
|---|---|
| 来源 | 可选 — 使用 `relayhelm skills install official/finance/stocks` 安装 |
| 路径 | `optional-skills/finance/stocks` |
| 版本 | `0.1.0` |
| 作者 | Mibay (Mibayy), Relayhelm |
| 许可证 | MIT |
...
```
SCRIPT=~/.relayhelm/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.relayhelm/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
