        ...
        {expanded && (
          <div className={styles.cardDetail}>
            ...
            <div className={styles.installHint}>
              <code>{skill.installCmd || `relayhelm skills install ${skill.name}`}</code>
              <CopyButton
                text={skill.installCmd || `relayhelm skills install ${skill.name}`}
              />
            </div>
            {onPick ? (
              <button
...
export default function SkillsDashboard() {
  ...
  // app (Relayhelm desktop's Bot Mode agent editor) as a skill PICKER. Site
      ...
      window.parent.postMessage(
        {
          ...
          installCmd: skill.installCmd || `relayhelm skills install ${skill.name}`,
          source: skill.source,
        },
        "*"
      );
  ...
  return (
    <Layout
      title="Skills Hub"
      description="Browse all skills and plugins available for Relayhelm"
    >
      <div className={`${styles.page} ${pickerMode ? styles.pickerMode : ""}`}>
        <header className={styles.hero}>
          <div className={styles.heroGlow} />
          <div className={styles.heroContent}>
            <p className={styles.heroEyebrow}>Relayhelm</p>
