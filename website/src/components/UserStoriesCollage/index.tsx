  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Relayhelm community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Relayhelm &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Relayhelm?{' '}
        <a
          href="https://github.com/InSelfControll/relayhelm/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
