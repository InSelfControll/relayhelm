...
#   Then set OPENAI_API_KEY or HERMES_MEET_REALTIME_KEY in ~/.relayhelm/.env
```
...
2. **Announce yourself** — no auto-consent. Say (in whatever channel the user is watching): "A Relayhelm agent bot is in this call taking notes."
