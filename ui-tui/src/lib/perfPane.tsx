...
//
// Both gate on HERMES_DEV_PERF=1 and dump JSON-lines (default ~/.relayhelm/perf.log,
...
const LOG_PATH = process.env.HERMES_DEV_PERF_LOG?.trim() || join(homedir(), '.relayhelm', 'perf.log')
