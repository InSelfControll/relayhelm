...
```bash
relayhelm skills install official/security/unbroker
```

Then start a new Relayhelm session and drive it (below). The skill works zero-config; a few optional
...
Drive it from a Relayhelm session:
...
- **PII handling.** Dossiers live under the Relayhelm home directory (`0600`, optionally
