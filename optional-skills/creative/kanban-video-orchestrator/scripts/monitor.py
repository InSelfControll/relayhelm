#!/usr/bin/env python3
"""
Monitor a running video-production kanban. Polls `relayhelm kanban list` and
...
def hermes_available() -> bool:
    return shutil.which("relayhelm") is not None
...
def kanban_list(tenant: str) -> list[dict]:
    ...
    try:
        ...
        pass
    # Fallback: textual parse of `relayhelm kanban list`
    out = subprocess.run(
