...
calls never come back as pending ``tool_calls`` (Relayhelm would re-run finished
work), so two subsystems would otherwise be blind to them:
  ...
  * the skill-review nudge, whose counter only moves on Relayhelm tool iterations.
