...
def test_control_plane_argv_is_not_a_gateway():
    ...
    serve = "C:\\Relayhelm\\.venv\\Scripts\\python.exe -m hermes_cli.main serve --host 127.0.0.1"
    run = "C:\\Relayhelm\\.venv\\Scripts\\python.exe -m hermes_cli.main gateway run"
...
def test_control_plane_classifier_is_token_based_not_substring():
    ...
    py = "C:\\Relayhelm\\.venv\\Scripts\\python.exe -m hermes_cli.main"
