"""Tests for the post-pull syntax guard in ``relayhelm update``.
...
markers in ``hermes_cli/config.py``; users who ran ``relayhelm update`` in
...
# release; if a future ``relayhelm update`` would brick users, this test fails
# in CI first.
# ---------------------------------------------------------------------------
