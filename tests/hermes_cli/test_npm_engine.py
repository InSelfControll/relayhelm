...
check: npm states the range it wants in the failure, Relayhelm upgrades only an
...
npm error engine Not compatible with your version of node/npm: relayhelm@1.0.0
npm error notsup Not compatible with your version of node/npm: relayhelm@1.0.0
...
class TestManagedDetection:
    ...
    no other npm — this is the boundary between "Relayhelm fixes it" and "the
...
class TestRepairDecision:
    ...
    def test_foreign_npm_provisions_managed_runtime_instead(
        ...
        """A system/nvm/brew/Nix npm is never modified — Relayhelm provisions its
