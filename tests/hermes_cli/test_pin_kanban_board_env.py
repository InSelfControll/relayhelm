...
`relayhelm kanban …`) inherit the same board the in-process kanban tools resolve.
Without this, a concurrent `relayhelm kanban boards switch` from another session
