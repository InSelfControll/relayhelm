"""POSIX advisory locks must survive Relayhelm' own database inspection.
...
Relayhelm used to byte-probe live databases in several places (kanban's
...
out across Relayhelm' inspection calls.
"""
