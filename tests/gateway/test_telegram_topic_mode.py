...
Telegram topics act as independent Relayhelm session lanes.
"""
...
async def test_group_new_keeps_existing_reset_semantics_when_dm_topic_mode_enabled(
    ...
    assert "Started a new Relayhelm session in this topic" not in result
