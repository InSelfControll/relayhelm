...
The fix writes snapshots under ``~/.relayhelm/sessions/saved/`` and prints
...
def test_save_conversation_writes_under_hermes_home(hermes_home, tmp_path, monkeypatch, capsys):
    """Snapshot must land under ~/.relayhelm/sessions/saved/, not CWD."""
    ...
    # File MUST be under ~/.relayhelm/sessions/saved/
    ...
    assert "relayhelm --resume 20260101_120000_abc123" in out, out
