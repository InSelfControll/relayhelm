...
class TestTerminalIntegration:
    ...
    def test_passthrough_cannot_override_provider_blocklist(self):
        ...
        Relayhelm provider credentials — that was the bypass where a skill
    ...
    def test_passthrough_cannot_override_internal_dynamic_secret(self):
        """A skill must NOT be able to register dynamically-named Relayhelm
    ...
    def test_non_hermes_api_key_still_registerable(self):
        ...
        Relayhelm provider credentials and must still pass through — skills
    ...
    def test_provider_blocklist_import_failure_fails_closed(self, monkeypatch):
        ...
        otherwise a skill could tunnel a Relayhelm credential into the
        ...
        it out of the child env. A non-Relayhelm key is also rejected here (the
