...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Relayhelm session"),
        ...
        _cmd("status", "Show Relayhelm session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Relayhelm agent"),
        ...
        _cmd("update", "Update Relayhelm to the latest version"),
        _cmd("restart", "Gracefully restart the Relayhelm gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Relayhelm session in it",
