...
Built for [Relayhelm](https://github.com/InSelfControll/relayhelm). Usable in any coding agent. Canonical source lives here; synced to [`InSelfControll/relayhelm/skills/creative/ascii-video`](https://github.com/InSelfControll/relayhelm/tree/main/skills/creative/ascii-video) via PR.
