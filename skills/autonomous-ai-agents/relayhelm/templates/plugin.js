/**
 * Relayhelm desktop plugin template. Save as:
 *   <hermes home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <hermes home> is ~/.relayhelm by default, or ~/.relayhelm/profiles/<name>
 * when running a named profile (`relayhelm -p <name>`). Run `relayhelm doctor` (or
