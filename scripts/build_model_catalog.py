#!/usr/bin/env python3
"""Build the Relayhelm Model Catalog — a centralized JSON manifest of curated models.
...
Relayhelm CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Relayhelm release.
...
os.environ.setdefault("HERMES_HOME", os.path.join(os.path.expanduser("~"), ".relayhelm"))
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Relayhelm '
