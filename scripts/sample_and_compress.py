...
DEFAULT_DATASETS = [
    ...
    "InSelfControll/relayhelm-megascience-sft1",
    "InSelfControll/relayhelm-Thinking-GLM-4.7-SFT2",
    "InSelfControll/relayhelm-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-relayhelm"
]
