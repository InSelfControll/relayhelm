#!/usr/bin/env python3
"""Build the Relayhelm Skills Index — a centralized JSON catalog of all skills.
...
`relayhelm skills search/install` can use it without hitting the GitHub API.
...
def main():
    print("Building Relayhelm Skills Index...", flush=True)
