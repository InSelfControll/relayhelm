#!/usr/bin/env python3
"""Drive the Relayhelm TUI under HERMES_DEV_PERF and summarize the pipeline.
...
~30 Hz (matching xterm key-repeat), summarizes ~/.relayhelm/perf.log on exit.
...
Environment overrides:
  HERMES_PERF_LOG     (default ~/.relayhelm/perf.log)
...
try:
    ...
    def get_hermes_home() -> Path:  # type: ignore[misc]
        ...
        return Path(val) if val else Path.home() / ".relayhelm"
