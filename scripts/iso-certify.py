...
What it does
------------
1. Spawns a SCRATCH dashboard (``relayhelm dashboard``) bound to loopback on a
   free port, with an ISOLATED ``HERMES_HOME`` (temp dir, minimal seeded state).
   It NEVER touches the live :9119 dashboard / io.github.inselfcontroll.relayhelm.dashboard / live
