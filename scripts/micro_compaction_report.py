#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Relayhelm logs.
...
With no LOGFILE, reads ``$HERMES_HOME/logs/agent.log`` (default ~/.relayhelm).
...
def default_log() -> Path:
    home = os.environ.get("HERMES_HOME") or str(Path.home() / ".relayhelm")
