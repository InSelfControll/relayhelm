...
Relayhelm (see website/docs/getting-started/platform-support.md). The
...
Relayhelm package derivation, so only that build may create an artifact.
...
_BLOCK_MESSAGE = (
    "Building wheels or sdists for relayhelm is not supported.\n"
    "Relayhelm is distributed via the shell installer, Docker image, or Nix.\n"
    ...
    "the Relayhelm Nix derivation sets HERMES_NIX_BUILD=1. If it does, file a bug."
)
