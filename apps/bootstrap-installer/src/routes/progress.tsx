...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Relayhelm' : 'Setting up Relayhelm'

  const description = isUpdate
    ? 'Relayhelm is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Relayhelm installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
