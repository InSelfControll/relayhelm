...
export const en: Translations = {
  ...
  boot: {
    ready: 'Relayhelm Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Relayhelm settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Relayhelm backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Relayhelm Desktop…'
    },
    errors: {
      backgroundExited: 'Relayhelm background process exited.',
      backgroundExitedDuringStartup: 'Relayhelm background process exited during startup.',
    ...
    failure: {
      title: "Relayhelm couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Relayhelm backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Relayhelm',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Relayhelm Desktop.',
    ...
    native: {
      ...
      inputBody: 'Relayhelm is waiting for your response.',
      turnDoneTitle: 'Relayhelm finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Relayhelm defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Relayhelm backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Relayhelm backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.relayhelm/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Relayhelm is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Relayhelm asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Relayhelm was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Relayhelm was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Relayhelm follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Relayhelm can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Relayhelm when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Relayhelm walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Relayhelm is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Relayhelm, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Relayhelm Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Relayhelm runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Relayhelm only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Relayhelm',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Relayhelm checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Relayhelm configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Relayhelm.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Relayhelm gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Relayhelm Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Relayhelm Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Relayhelm runtime managed by this app.',
      kindRemoteDesc: 'A Relayhelm gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Relayhelm Cloud account.',
      kindSshDesc: 'A Relayhelm install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Relayhelm manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Relayhelm Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Relayhelm backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private Relayhelm backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Relayhelm backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Relayhelm Cloud',
      cloudDesc: 'Sign in once to Relayhelm Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Relayhelm Cloud',
      cloudSignIn: 'Sign in to Relayhelm Cloud',
      cloudSignedIn: 'Signed in to Relayhelm Cloud',
      cloudNeedsSignIn: 'Sign in to Relayhelm Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Relayhelm Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Relayhelm Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Relayhelm Cloud',
      cloudSignedOutMessage: 'Cleared the Relayhelm Cloud session.',
      ...
      restartingMessage: 'Relayhelm Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Relayhelm ${version}` : ''}`,
      ...
      sshDesc:
        'Relayhelm is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Relayhelm path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Relayhelm found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Relayhelm runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Relayhelm is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/InSelfControll/relayhelm/main/scripts/install.sh | sh) or set the Relayhelm path.',
      sshErrPlatform:
        'Unsupported remote platform. Relayhelm Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Relayhelm on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Relayhelm. Review the exact configuration below — it comes from the link, not from Relayhelm.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Relayhelm starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Relayhelm ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Relayhelm runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Relayhelm at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Relayhelm browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Relayhelm builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Relayhelm to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Relayhelm to generate pets.',
      backgroundHint: 'You can close this — Relayhelm will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Relayhelm desktop' },
    ...
    hermesActiveSessions: (version, count) => `Relayhelm ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Relayhelm you point it at, instead of this computer.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Relayhelm environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Relayhelm did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Relayhelm will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Relayhelm backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Relayhelm. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Relayhelm backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Relayhelm...',
    placeholderReconnecting: 'Reconnecting to Relayhelm…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Relayhelm a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Relayhelm will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Relayhelm to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Relayhelm…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Relayhelm…',
    ...
    unsupportedMessage: 'This version of Relayhelm can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Relayhelm from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Relayhelm will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Relayhelm desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Relayhelm updater takes over in its own window and reopens Relayhelm automatically when it’s done. Please don’t reopen Relayhelm yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Relayhelm reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Relayhelm reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Relayhelm?',
    blockerBody:
      'Relayhelm needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Relayhelm',
    foreignBlockerBody:
      'Relayhelm can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Relayhelm can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Relayhelm needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Relayhelm Desktop',
    setupChoiceDesc:
      'Connect this app to a Relayhelm gateway you already run, or install Relayhelm locally on this computer.',
    connectExistingTitle: 'Connect to existing Relayhelm',
    ...
    installLocalTitle: 'Install Relayhelm locally',
    installLocalDesc: 'Download Relayhelm, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Relayhelm Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Relayhelm',
    remoteSetupDesc: 'Enter your gateway URL. Relayhelm Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Relayhelm gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Relayhelm gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Relayhelm',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Relayhelm CLI or desktop instance is running. Stop any running Relayhelm instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Relayhelm",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Relayhelm is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Relayhelm…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Relayhelm',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Relayhelm at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Relayhelm connects automatically',
    ...
    authorizeThere: 'Authorize Relayhelm there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Relayhelm there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Relayhelm Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Relayhelm Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Relayhelm will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Relayhelm is restarting...',
      askRestart: 'Ask Relayhelm to restart the server',
      lookingRestart: taskId => `Relayhelm is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Relayhelm is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Relayhelm to open a page.',
      finishedRestarting: message => `Relayhelm finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Relayhelm could not restart the server.',
      stillWorking:
        'Relayhelm is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Relayhelm is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Relayhelm gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.relayhelm/config.yaml). Relayhelm won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Relayhelm needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Relayhelm needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Relayhelm Desktop to use Save Image.',
    restartToSaveImages: 'Restart Relayhelm Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `relayhelm gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Relayhelm loads when the work calls for them.'
      },
      messaging: {
        title: 'Relayhelm away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Relayhelm made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Relayhelm — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
