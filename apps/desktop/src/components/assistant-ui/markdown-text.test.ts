...
describe('preprocessMarkdown', () => {
  ...
  it('does not swallow trailing emphasis asterisks into an autolinked url', () => {
    const input = '**PR opened: https://github.com/InSelfControll/relayhelm/pull/12345**'
    ...
    expect(output).toContain('<https://github.com/InSelfControll/relayhelm/pull/12345>')
