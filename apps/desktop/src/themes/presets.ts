...
/**
 * Nous — the canonical Relayhelm desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Relayhelm's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Relayhelm desktop identity: GitHub's chrome carrying Nous
