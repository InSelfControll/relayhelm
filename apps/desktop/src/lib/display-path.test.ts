...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/relayhelm')).toBe('~/www/relayhelm')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/relayhelm')).toBe('relayhelm')
    expect(pathLeaf('~/www/relayhelm')).toBe('relayhelm')
