...
//
// When someone is in a hands-free "Hey Relayhelm" voice chat, the natural way to
...
// phrase (optionally addressed to Relayhelm), so a real turn that merely contains
 ...
 * to Relayhelm). Returns false for anything that merely contains "stop" as part of
