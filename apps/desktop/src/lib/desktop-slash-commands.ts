...
/** Why a known Relayhelm command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Relayhelm profile', surface: action('profile') },
  {
    name: '/skin',
 ...
 * Relayhelm' built-in slash commands — i.e. skill commands (`/gif-search`,
 ...
 * activity — the ones that ship with Relayhelm and were never asked for. It is
