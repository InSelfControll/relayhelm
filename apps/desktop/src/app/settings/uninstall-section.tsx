...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The Relayhelm agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the Relayhelm agent, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Chat GUI and the Relayhelm agent (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the Relayhelm agent, and all of your config, chats, secrets, and logs',
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="text-sm font-medium">Uninstall Relayhelm</p>
