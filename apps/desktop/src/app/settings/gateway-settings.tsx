...
// Relayhelm Cloud discovery lifecycle for the cloud-mode panel.
...
export function GatewaySettings({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  // --- Relayhelm Cloud (cloud mode) state ---
  ...
  return (
    <SettingsContent bare={embedded}>
      ...
      {/* Relayhelm Cloud panel: one portal sign-in, then a discovered-agent picker
