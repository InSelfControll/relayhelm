...
// "Timed out connecting to Relayhelm backend" that hangs the UI (#48504).
//
...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Relayhelm gateway connection closed',
      connectErrorMessage: 'Could not connect to Relayhelm gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Relayhelm gateway is not connected',
