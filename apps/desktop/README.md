...
<p align="center">
  <a href="https://github.com/InSelfControll/relayhelm/releases"><img src="https://img.shields.io/badge/Download-macOS%20%C2%B7%20Windows%20%C2%B7%20Linux-FFD700?style=for-the-badge" alt="Download"></a>
  <a href="https://hermes-agent.nousresearch.com/docs/"><img src="https://img.shields.io/badge/Docs-hermes--agent.nousresearch.com-FFD700?style=for-the-badge" alt="Documentation"></a>
  <a href="https://discord.gg/NousResearch"><img src="https://img.shields.io/badge/Discord-5865F2?style=for-the-badge&logo=discord&logoColor=white" alt="Discord"></a>
  <a href="https://github.com/InSelfControll/relayhelm/blob/main/LICENSE"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT"></a>
</p>

**The native desktop app for [Relayhelm](../../README.md) — the self-improving AI agent from [Nous Research](https://nousresearch.com).** Same agent, same skills, same memory as the CLI and gateway, in a polished native window — chat with streaming tool output, side-by-side previews, a file browser, voice, and settings, no terminal required. Available for **macOS, Windows, and Linux**.

<table>
<tr><td><b>Chat with the full agent</b></td><td>Streaming responses, live tool activity, structured tool summaries, and the same conversation history as every other Relayhelm surface.</td></tr>
<tr><td><b>Side-by-side previews</b></td><td>Render web pages, files, and tool outputs in a right-hand pane while you keep chatting.</td></tr>
<tr><td><b>File browser</b></td><td>Explore and preview the working directory without leaving the app.</td></tr>
<tr><td><b>Voice</b></td><td>Talk to Relayhelm and hear it back.</td></tr>
...
### Install with Relayhelm (recommended)

Already have the Relayhelm CLI? Just run:

```bash
hermes desktop
```

It builds and launches the GUI against your existing install — same config, keys, sessions, and skills. If Desktop cannot find a usable runtime or saved remote connection, first launch lets you connect to an existing Relayhelm gateway or install Relayhelm locally. Local onboarding then walks you through choosing a provider and model.

### Prebuilt installers

Prebuilt installers are built and distributed via [the Relayhelm Desktop website.](https://hermes-agent.nousresearch.com/).
...
first launch it can install the Relayhelm runtime into `HERMES_HOME`
(`~/.relayhelm`, or `%LOCALAPPDATA%\hermes` on Windows), using the same layout as a
CLI install.
...
- **Relayhelm** runs as a headless `relayhelm serve` process and exposes the
...
5. a system Python that can import the Relayhelm runtime
...
Desktop supports a managed local backend, explicit remote gateways, and Relayhelm
...
screen offers **Connect to existing Relayhelm** before starting the local installer.
...
terminal commands, and file operations run against the remote Relayhelm host, not
...
```powershell
# Force a clean first-launch setup
Remove-Item "$env:LOCALAPPDATA\hermes\relayhelm\.hermes-bootstrap-complete"
# Rebuild a broken Python venv
Remove-Item -Recurse -Force "$env:LOCALAPPDATA\hermes\relayhelm\venv"
```

> The default Relayhelm home on Windows is `%LOCALAPPDATA%\hermes`. Set the `HERMES_HOME` env var if you've relocated it.
