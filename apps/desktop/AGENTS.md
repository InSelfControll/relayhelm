...
How to build Relayhelm Desktop well. This is a judgment guide, not an inventory —
...
- The **backend** is authoritative for anything another Relayhelm surface can also
...
its shape. "Plugin" means several unrelated things across Relayhelm — do not assume
