 ...
 *
 * A public install can end up with `origin=git@github.com:InSelfControll/relayhelm.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/InSelfControll/relayhelm.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/inselfcontroll/relayhelm'
