...
test('isWindowsBinaryPathInWsl blocks Windows binary types on WSL', () => {
  assert.equal(isWindowsBinaryPathInWsl('/mnt/c/Tools/relayhelm.exe', { isWsl: true }), true)
  assert.equal(isWindowsBinaryPathInWsl('/mnt/c/Tools/relayhelm.cmd', { isWsl: true }), true)
  ...
  assert.equal(isWindowsBinaryPathInWsl('/usr/local/bin/relayhelm', { isWsl: true }), false)
  assert.equal(isWindowsBinaryPathInWsl('/mnt/c/Tools/relayhelm.exe', { isWsl: false }), false)
})
