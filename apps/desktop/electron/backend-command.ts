// Backend subcommand routing for the desktop-managed Relayhelm process.
//
// The desktop app launches its own headless backend via `relayhelm serve` — it
 ...
 * @param {string} [profile] optional Relayhelm profile to pin via `--profile`.
 */
