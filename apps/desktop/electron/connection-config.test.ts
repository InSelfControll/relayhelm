...
test('cookiesHavePrivySession does NOT treat relayhelm gateway cookies as a portal session', () => {
...
test('gateway WS URL IPC result serializes success and the auth-vs-transport matrix', async () => {
  ...
  for (const error of [
    ...
    new Error('Timed out connecting to Relayhelm backend after 8000ms'),
