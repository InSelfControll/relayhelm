...
// even though a fresh shell — and the Relayhelm CLI — sees it immediately. The
// desktop's HERMES_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\relayhelm. Reading
...
//       HERMES_HOME    REG_SZ    F:\Relayhelm\data
//
