// Launching the Relayhelm TUI in the user's OWN terminal emulator.
//
...
// `relayhelm --tui --resume <id>` there. Two problems have to be solved for that
// to work anywhere:
//
//  1. WHAT to run. The desktop's Relayhelm runtime is often a venv Python invoked
 ...
 * headless child) is the wrong answer for an interactive terminal. The Relayhelm
