 ...
 *
 * Each entry is a key/value pair that lands in the packaged Relayhelm.app's
 ...
 * "Relayhelm wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Relayhelm wants to access Music" when Relayhelm never touches the Music
