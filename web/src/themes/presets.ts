...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Relayhelm Teal",
  description: "Classic dark teal — the canonical Relayhelm look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Relayhelm Teal (Large)",
  description: "Relayhelm Teal with bigger fonts and roomier spacing",
