...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateHermes: "Werk Relayhelm op",
    updatingHermes: "Besig om Relayhelm op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Hermes-inproppe op (`relayhelm plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.relayhelm/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.relayhelm/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.relayhelm/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrêre omgewingsveranderlikes wat in jou .env gestoor is en wat Relayhelm nie herken nie. Gebruik dit om omgewingsveranderlikes vir vaardighede, MCP-bedieners of jou eie gereedskap in te spuit.",
  ...
  achievements: {
    ...
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Relayhelm meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Relayhelm 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Relayhelm skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
