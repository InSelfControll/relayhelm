...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateHermes: "Relayhelm aktualisieren",
    updatingHermes: "Relayhelm wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Hermes-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `relayhelm plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.relayhelm/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.relayhelm/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.relayhelm/skills/ geladen",
  ...
  env: {
    ...
    customHint: "Beliebige Umgebungsvariablen in deiner .env, die Relayhelm nicht erkennt. Verwende sie, um Umgebungsvariablen für Skills, MCP-Server oder eigene Tools einzuschleusen.",
  ...
  achievements: {
    ...
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Relayhelm mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Relayhelm ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Relayhelm scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
