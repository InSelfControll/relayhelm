...
export const en: Translations = {
  ...
  status: {
    ...
    updateHermesConfirmMessage:
      "This runs relayhelm update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateHermesConfirmNow: "Update now",
    updateHermesConfirmTitle: "Update Relayhelm?",
    updatingHermes: "Updating Relayhelm…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Relayhelm plugins (`relayhelm plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.relayhelm/plugins/?",
    removeHint: "Only user-installed plugins under ~/.relayhelm/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.relayhelm/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Relayhelm doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Relayhelm badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Relayhelm session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Relayhelm more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Relayhelm sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Relayhelm is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
