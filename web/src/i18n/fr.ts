...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateHermes: "Mettre à jour Relayhelm",
    updatingHermes: "Mise à jour de Relayhelm…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Relayhelm (parité avec `relayhelm plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.relayhelm/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.relayhelm/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.relayhelm/skills/",
  ...
  config: {
    configPath: "~/.relayhelm/config.yaml",
    filters: "Filtres",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Variables d'environnement arbitraires stockées dans votre .env que Relayhelm ne reconnaît pas. Utilisez-les pour injecter des variables d'environnement pour des compétences, des serveurs MCP ou vos propres outils.",
  ...
  achievements: {
    hero: {
      ...
      title: "Relayhelm Achievements",
      subtitle:
        "Badges Relayhelm à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Relayhelm en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Relayhelm davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Relayhelm détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Relayhelm analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Relayhelm ☤",
    },
  },
  kanban: {
