/**
 * ChatPage — embeds `relayhelm --tui` inside the dashboard.
 *
...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  const [banner, setBanner] = useState<string | null>(() =>
    ...
    !window.__HERMES_AUTH_REQUIRED__
      ? "Session token unavailable. Open this page through `relayhelm dashboard`, not directly."
      : null,
  );
  ...
  useEffect(() => {
    ...
    const term = new Terminal({
      ...
      // even when the inner Relayhelm TUI has enabled xterm mouse-events
    ...
    // forwarding them into Relayhelm. Keyboard input, paste, and resize still
    // behave normally.
